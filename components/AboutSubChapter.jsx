...
const AboutSubChapter = () => {
  ...
  return (
    <main className="w-full min-h-screen mx-auto grid place-items-center bg-blue-100">
      <div className="grid place-items-center grid-cols-1 w-full mx-auto max-w-5xl shadow-5xl rounded-2xl">
